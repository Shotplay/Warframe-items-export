...
async function generateData(locales, typeReturn = "CSV") {
    ...
    switch (typeReturn) {
        ...
        case "SQL": {
            ...
            const insertions = flatted.map((data) => `INSERT INTO \`warframeLocalizations\`(\`${Object.keys(data).join("`,`")}\`) VALUES ('${Object.values(data)
            ...
            fs_1.default.writeFileSync(path_1.default.join(OutputDir, "output.sql"), data, "utf-8");
            return data;
        }
        case "CSV": {
